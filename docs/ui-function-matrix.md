...
| Stammbaum | Karteninteraktion und Navigation | aktiv | größere feste Karten ohne Transparenz bei Hover/Auswahl, genealogisches ParentGroup-/Connection-Modell, gekrümmte Verbindungspfade, Mausrad-Zoom zur Zeigerposition, Pan mit Grenzen, Auswahl zentrieren, Baum einpassen und Ansicht zurücksetzen |
